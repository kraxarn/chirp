...
{
	if (SDL_strcasecmp(name, button_left) == 0)
	{
		return SDL_BUTTON_LEFT;
	}

	if (SDL_strcasecmp(name, button_middle) == 0)
	{
		return SDL_BUTTON_MIDDLE;
	}

	if (SDL_strcasecmp(name, button_right) == 0)
	{
		return SDL_BUTTON_RIGHT;
	}

	if (SDL_strcasecmp(name, button_side1) == 0)
	{
		return SDL_BUTTON_X1;
	}

	if (SDL_strcasecmp(name, button_side2) == 0)
	{
