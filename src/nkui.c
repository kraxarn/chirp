...
static void set_default_theme(nk_context_t *ctx)
{
	...
	const nk_color_t theme[] = {
		...
		[NK_COLOR_COMBO] = palette[5],
		[NK_COLOR_CHART] = invalid,
		[NK_COLOR_CHART_COLOR] = invalid,
		[NK_COLOR_CHART_COLOR_HIGHLIGHT] = invalid,
		[NK_COLOR_SCROLLBAR] = palette[4],
		[NK_COLOR_SCROLLBAR_CURSOR] = palette[3],
		[NK_COLOR_SCROLLBAR_CURSOR_HOVER] = palette[2],
		[NK_COLOR_SCROLLBAR_CURSOR_ACTIVE] = palette[1],
